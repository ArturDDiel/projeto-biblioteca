...
<head>
    ...
    <title>Projeto Biblioteca - Lista Pessoas</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            ...
            <a class="cadastro" href="/pessoa/cadastro">Cadastrar</a>
        </div>
    </nav>
        ...
        <div class="tabela-livros">
            ...
            <div>
                @foreach ($listaPessoa as $pessoa)
                    <ul class="area1">
                        <li class="id">{{ $pessoa->id }}</li>
                        <img class="perfil" src="/storage/foto-pessoa/{{ $pessoa->fotoPessoa }}" alt="Foto">
                        <ul class="area2">
                            <li>{{ $pessoa->nome }}</li>
                            <li>{{ $pessoa->endereco }}, {{ $pessoa->numero }}</li>
                            <li>{{ $pessoa->telefone }}</li>
                            <li>{{ $pessoa->email }}</li>
                        </ul>
                    </ul>
                    <span class="area-excluir">
                        <form action="/pessoa/{{ $pessoa->id }}/excluir" method="POST"
