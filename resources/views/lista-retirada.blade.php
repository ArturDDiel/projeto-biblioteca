...
<head>
    ...
    <title>Projeto Biblioteca - Lista Retiradas</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            ...
            <a class="cadastro" href="/retirada/cadastro">Cadastrar</a>
        </div>
    </nav>
    ...
    <div>
        ...
        <div class="tabela-livros">
            <h1>Retiradas e Devoluções</h1>
            <div>
                @foreach ($listaRetirada as $retirada)
                    <ul class="area1">
                        <li class="id">{{ $retirada->id }}</li>
                        <ul class="area2">
                            <li><b>Pessoa:</b> {{ $retirada->pessoa }}</li>
                            <li><b>Livro:</b> {{ $retirada->livro }}</li>
                            <li><b>Data de retirada:</b> {{ date('d/m/Y', strtotime($retirada->dataRetirada)) }}</li>
                            <li><b>Data de devolução:</b> {{ date('d/m/Y', strtotime($retirada->dataDevolucao)) }}
                            </li>
                        </ul>
                    </ul>
                    <span class="area-excluir">
                        <form action="/retirada/{{ $retirada->id }}/excluir" method="POST"
