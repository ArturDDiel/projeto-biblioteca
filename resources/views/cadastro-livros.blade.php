...
<head>
    ...
    <title>Projeto Biblioteca - Cadastro Livros</title>
    ...
    <div class="container">
        <div class="sobre-card">
            <div class="card">
                ...
                <form action="/livro/cadastro" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="autor" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
